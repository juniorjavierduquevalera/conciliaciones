...
const ComisionesBancariasTable: React.FC = () => {
  const { comisiones, isLoading, fetchComisiones } =
    useComisionesBancariasStore();
  ...
  const columns: TableColumn<ComisionBancaria>[] = [
    ...
    { name: "Cargo", selector: (row) => row.cargo, sortable: true },
    {
      ...
      selector: (row) => row.codigo_operacion,
      sortable: true,
    },
    {
      name: "Tipo Operación",
    ...
    {
      name: "Tasa de Cambio",
      selector: (row) => row.tasa_de_cambio ?? "",
      sortable: true,
    },
    {
      name: "Moneda Nacional",
      selector: (row) => row.moneda_nacional,
      sortable: true,
    },
    {
      name: "Moneda Extranjera",
      selector: (row) => row.moneda_extranjera,
      sortable: true,
    },
    {
      name: "Cambio",
      selector: (row) => row.cambio?.toString() ?? "",
      sortable: true,
    },
    {
      name: "Conversión",
      selector: (row) => row.conversion?.toString() ?? "",
      sortable: true,
    },
  ...
  const flattenedComisionesBancarias = comisiones.flat();
  return (
