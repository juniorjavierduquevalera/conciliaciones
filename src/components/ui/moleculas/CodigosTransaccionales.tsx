...
export const CodigosTransaccionales: React.FC = () => {
  const { data: codigosTransaccionales, isLoading } =
    useFetchData<interfaceCodigosTransaccionales>(
      "https://lv9d0stg-4000.use2.devtunnels.ms/api/codigo-transaccionales"
    );
  if (isLoading) {
